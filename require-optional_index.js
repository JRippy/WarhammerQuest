...
var require_optional = function(name, options) {
  ...
  try {
    ...
    // console.log("###############################################################");
    // console.log(moduleEntryFile);
    // console.log("###############################################################");
    switch (moduleEntryFile) {
      case 'mongodb-extjson':
        moduleEntry = require('mongodb-extjson');
        break;
      case 'bson-ext':
        moduleEntry = require('bson-ext');
        break;
      case 'snappy':
        moduleEntry = require('snappy');
        break;
    }
  ...
  switch (moduleEntryFile) {
    case 'mongodb-extjson':
      var location = find_package_json(require.resolve('mongodb-extjson'));
      break;
    case 'bson-ext':
      var location = find_package_json(require.resolve('bson-ext'));
      break;
    case 'snappy':
      var location = find_package_json(require.resolve('snappy'));
      break;
  }
